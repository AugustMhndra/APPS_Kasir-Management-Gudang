...
// Ubah metode autonumber() agar mengembalikan nomor otomatis yang baru
public String autonumber() {
    try {
        ...
        rst = pst.executeQuery();
        if (rst.next()) {
            if (rst.getString("NO") == null) {
                return "TRX001";
            } else {
                int auto_id = Integer.parseInt(rst.getString("NO")) + 1;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        KD="D"+Kode_detail;
            ...
            String update = "UPDATE barang SET Stok=? WHERE Kode_Barang=?";
            pst=koneksi.prepareStatement(sql);
            pst2=koneksi.prepareStatement(update);
            pst.setString(1, KD);
            ...
            pst.execute();
            pst2.setString(1, Integer.toString(kstok));
            pst2.setString(2, barang);        
            pst2.execute();
        } catch (Exception e){
            JOptionPane.showMessageDialog(null, e);
            }
